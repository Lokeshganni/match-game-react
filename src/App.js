...
const stateObj = {
  initialActiveTabItem: tabsList[0],
...
class App extends Component {
  ...
  getRandomImage = () => {
    ...
    this.setState({randomObj: imagesList[randomIndex]})
  }
  ...
  onClickTabItem = tabId => {
    const activeTabItem = tabsList.find(each => tabId === each.tabId)
    this.setState({initialActiveTabItem: activeTabItem})
  }
  ...
  render() {
    const {initialActiveTabItem, randomObj, score, timer} = this.state
    const filteredImagesList = imagesList.filter(
      each => each.category === initialActiveTabItem.tabId,
    )
    ...
    return (
      <div className="app-container">
        <ul>
          ...
          <li>
            <div className="score-nd-time-main-container">
              <p className="score-para">
                Score: <span className="score-span-ele">{score}</span>
              </p>
              <div className="timer-display-container">
                <img
                  ...
                  className="timer-png"
                />
                <p className="timer-secs-para">{timer} Sec</p>
              </div>
            </div>
          </li>
        </ul>
        ...
        <div className="match-game-container">
          {timer > 0 ? (
            <div className="main-container">
              ...
              <ul className="tab-item-ul-container">
                {tabsList.map(each => (
                  <TabItem
                    isActive={initialActiveTabItem.tabId === each.tabId}
            ...
            <div className="final-score-container">
              ...
              <p className="final-score-para">{score}</p>
              <button
